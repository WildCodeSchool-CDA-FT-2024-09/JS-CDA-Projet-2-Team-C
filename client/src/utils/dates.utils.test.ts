import { frenchDate, getAge } from './dates.utils';
...
describe('frenchLargeDate utility', () => {
  ...
  it('should handle a string date input correctly', () => {
    ...
    expect(frenchDate(inputDate)).toBe(expectedOutput);
  });
  ...
  it('should handle compact parameter', () => {
    const inputDate = '2023-12-01';
    const expectedOutput = '01/12/2023';
    expect(frenchDate(inputDate, true)).toBe(expectedOutput);
  });

...
const { MEDAGENDA_URI, EMAIL_DOCTOR, PASSWORD_FAKE } = process.env;

if (!MEDAGENDA_URI || !EMAIL_DOCTOR || !PASSWORD_FAKE) {
  throw new Error(
    'MEDAGENDA_URI, EMAIL_DOCTOR and PASSWORD_FAKE environment variables are required'
  );
}
